...
const VALUE_SLIDES: Slide[] = [
  ...
  },
  {
    ...
    title: 'صدای موتور را ضبط کن',
    body: 'صدای موتور را بفرست تا نشانه‌های صوتی و اطلاعات خودرو در بررسی اولیه وارد شوند و یک سرنخ بهتر بگیری.',
    cta: 'شروع عیب‌یابی',
    href: '/diagnose',
    icon: '🎙️',
  },
...
const CATEGORY_SLIDES: Slide[] = [
  ...
  {
    eyebrow: 'پوشش گسترده خودروها',
    title: 'برای وسیله‌ات، مسیر بررسی را روشن‌تر کن',
    body: 'از خودروهای سواری تا خودروها و تجهیزات سنگین؛ نوع وسیله را انتخاب کن و بررسی را با اطلاعات دقیق‌تر شروع کن.',
    cta: 'انتخاب وسیله',
    href: '/diagnose',
    icon: '🚚',
  },
  {
    ...
    body: 'قبل از تعویض قطعه، سؤال‌های درست را بشناس و تصمیم آگاهانه‌تری بگیر؛ مکانیک هوشمند جای تعمیرکار را نمی‌گیرد.',
    cta: 'راهنمایی بگیر',
    href: '/diagnose',
    icon: '🛡️',
  },
