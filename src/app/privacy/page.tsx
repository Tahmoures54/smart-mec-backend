    ...
    <SiteShell>
      <article className="mx-auto max-w-2xl px-4 py-16 leading-8 text-amber-100/85">
        ...
        <ul className="mt-3 list-disc pr-5">
          ...
          <li>اطلاعات پرداخت از طریق درگاه زیبال (مبلغ، شناسه پیگیری؛ شماره کارت کامل ذخیره نمی‌شود)</li>
        </ul>
        <h2 className="mt-8 text-xl font-semibold text-amber-100">نحوه استفاده</h2>
        <p className="mt-3">
          اطلاعات فقط برای عیب‌یابی، نمایش تعمیرگاه نزدیک، مدیریت حساب و تکمیل پرداخت استفاده می‌شود.
        </p>
