  ...
  return (
    ...
    >
      ...
      <p className="text-lg text-gray-300 max-w-xl text-center mb-8">
        سرور API اپلیکیشن فلاتر مکانیک هوشمند. سال ساخت خودرو توسط کاربر ارسال
        می‌شود.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-3xl">
        <div className="bg-gray-800 p-6 rounded-lg border border-orange-500/30">
          ...
          <ul className="space-y-2 text-gray-300">
            <li>
              <code className="text-orange-300 bg-gray-900 px-1 rounded">
                /api/account
              </code>{' '}
              - ورود OTP
            </li>
            <li>
              ...
              - عیب‌یابی AI (carId + year + description)
            </li>
            <li>
              <code className="text-orange-300 bg-gray-900 px-1 rounded">
                /api/purchase
        ...
        <div className="bg-gray-800 p-6 rounded-lg border border-orange-500/30">
          ...
          <div className="flex items-center space-x-2 space-x-reverse">
            ...
            <span className="text-green-400">آماده سرویس‌دهی</span>
          </div>
          <div className="mt-4">
            <Link
              href="/api/health"
