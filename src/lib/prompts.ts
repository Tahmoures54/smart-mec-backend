...
- شماره دور بعدی دقیقاً followUpRound قبلی + 1 باشد.
- اگر followUpRound قبلی کمتر از ${RULES_CONFIG.maxFollowUpRounds} است، می‌توانی تا ${RULES_CONFIG.maxQuestionsPerRound} سؤال جدید یکجا بپرسی.
